...
class holy_quran_random_widget extends WP_widget{
	...
	function __construct(){
		...
		parent::__construct("quran_random", "Quran random verse",$options);
	}
...
echo '<br><a href="'.get_site_url().'/?sourate='.$num[0].'&lang='.get_option('quran_languages').'">Sura '.$num[0].'</a>';
if($d['quran_audio_verset'] == "active"){
echo '<a href="//islamaudio.fr/verset/'.$recitator.'/'.$num[0].'/'.$nbr.'.mp3"><img class="img_play" src="'.plugin_dir_url( __FILE__ ).'/img/play.png"></a>';
}
		}
	}		
	}
...
echo '<br><a href="//islamaudio.fr/verset/'.$recitator.'/'.$num[0].'/'.$nbr.'.mp3"><img class="img_play" src="'.plugin_dir_url( __FILE__ ).'/img/play.png"></a>';	
}
?>
</span>
<?php	
	...
	<form method="post">
		...
		<p>
			...
			<option value="arabe"<?php if(isset($d['language'])){if($d['language'] == "arabe"){echo 'selected="selected"';}}?>>Arabe</option>				
			<option value="english"<?php if(isset($d['language'])){if($d['language'] == "english"){echo 'selected="selected"';}}?>>English</option>			
			<option value="francais"<?php if(isset($d['language'])){if($d['language'] == "francais"){echo 'selected="selected"';}}?>>Français</option>
			<option value="german"<?php if(isset($d['language'])){if($d['language'] == "german"){echo 'selected="selected"';}}?>>German</option>
			<option value="dutch"<?php if(isset($d['language'])){if($d['language'] == "dutch"){echo 'selected="selected"';}}?>>Dutch</option>	
			<option value="russian"<?php if(isset($d['language'])){if($d['language'] == "russian"){echo 'selected="selected"';}}?>>Russian</option>	
			<option value="albanian"<?php if(isset($d['language'])){if($d['language'] == "albanian"){echo 'selected="selected"';}}?>>Albanian</option>
			<option value="azerbaijani"<?php if(isset($d['language'])){if($d['language'] == "azerbaijani"){echo 'selected="selected"';}}?>>Azerbaijani</option>
			<option value="bengali"<?php if(isset($d['language'])){if($d['language'] == "bengali"){echo 'selected="selected"';}}?>>Bengali</option>	
			<option value="bosnian"<?php if(isset($d['language'])){if($d['language'] == "bosnian"){echo 'selected="selected"';}}?>>Bosnian</option>		
			<option value="bulgarian"<?php if(isset($d['language'])){if($d['language'] == "bulgarian"){echo 'selected="selected"';}}?>>Bulgarian</option>	
			<option value="chinese"<?php if(isset($d['language'])){if($d['language'] == "chinese"){echo 'selected="selected"';}}?>>Chinese</option>
			<option value="czech"<?php if(isset($d['language'])){if($d['language'] == "czech"){echo 'selected="selected"';}}?>>Czech</option>
			<option value="indonesian"<?php if(isset($d['language'])){if($d['language'] == "indonesian"){echo 'selected="selected"';}}?>>Indonesian</option>
			<option value="italian"<?php if(isset($d['language'])){if($d['language'] == "italian"){echo 'selected="selected"';}}?>>Italian</option>
			<option value="kurdish"<?php if(isset($d['language'])){if($d['language'] == "kurdish"){echo 'selected="selected"';}}?>>Kurdish</option>
			<option value="malay"<?php if(isset($d['language'])){if($d['language'] == "malay"){echo 'selected="selected"';}}?>>Malay</option>
			<option value="norwegian"<?php if(isset($d['language'])){if($d['language'] == "norwegian"){echo 'selected="selected"';}}?>>Norwegian</option>
			<option value="portuguese"<?php if(isset($d['language'])){if($d['language'] == "portuguese"){echo 'selected="selected"';}}?>>Portuguese</option>
			<option value="romanian"<?php if(isset($d['language'])){if($d['language'] == "romanian"){echo 'selected="selected"';}}?>>Romanian</option>
			<option value="somali"<?php if(isset($d['language'])){if($d['language'] == "somali"){echo 'selected="selected"';}}?>>Somali</option>
			<option value="spanish"<?php if(isset($d['language'])){if($d['language'] == "spanish"){echo 'selected="selected"';}}?>>Spanish</option>	
			<option value="swedish"<?php if(isset($d['language'])){if($d['language'] == "swedish"){echo 'selected="selected"';}}?>>Swedish</option>	
			<option value="turkish"<?php if(isset($d['language'])){if($d['language'] == "turkish"){echo 'selected="selected"';}}?>>Turkish</option>				
			</select>
		</p>
		<p>
...
<a href="https://gp-codex.fr" target="_blank"> <img style="width:150px" src="https://gp-codex.fr/donpp.png" name="submit" alt="PayPal - la solution de paiement en ligne la plus simple et la plus sécurisée !" border="0" type="image"></a>
<p style="margin-top:20px;position:absolute">Barak'Allah oufikoum for your help</p>				
		<?php
	}
}